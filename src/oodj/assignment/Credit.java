...
import static oodj.assignment.DataIO.allCustomers;
...
public class Credit extends javax.swing.JFrame {
    ...
    public Credit() {
        initComponents();
        showCreditAndTransactionHistory();
    }

    public void showCreditAndTransactionHistory(){
        
        jTextArea1.setText(" Rm " + customer.getCredit());
